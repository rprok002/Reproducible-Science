...
summary(NaiveDeadFIUPanamaGLMM)
anova(NaiveDeadFIUPanamaGLMM)
NaiveDeadFIUPanamaGLMM <- lmer(Seconds_Fixed_SR~Group+Sex+Total_Seconds_Fixed_SR+(1|Frog_Number)+Trial.Order+Liquid.Amount, data = NaiveDeadFIUPanamaAnalysisNoOutliers)
summary(NaiveDeadFIUPanamaGLMM)
anova(NaiveDeadFIUPanamaGLMM)
