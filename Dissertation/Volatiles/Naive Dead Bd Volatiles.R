...
frog1br <- c(0.33266129, 0.25155556)
mean(frog1br)
sd(frog1br)
frog1bd <- c(0.66733871,0.74844444)
mean(frog1bd)
sd(frog1bd)
...
mean(frog5bd)
sd(frog5bd)
frog6br <- c(0.193236715)
mean(frog6br)
sd(frog6br)
frog6bd <- c(0.799516908)
mean(frog6bd)
sd(frog6bd)
frog7br1 <- c(0.295511222, 0.613712375)
mean(frog7br1)
sd(frog7br1)
frog7br2 <- c(0.704488778,0.386287625)
mean(frog7br2)
sd(frog7br2)
frog9br <- c(0.729468599,0.364130435)
mean(frog9br)
sd(frog9br)
frog9bd <- c(0.270531401,0.635869565)
mean(frog9bd)
sd(frog9bd)
frog10br1 <- c(0.656957929)
mean(frog10br1)
sd(frog10br1)
frog10br2 <- c(0.343042071)
mean(frog10br2)
sd(frog10br2)
frog11br1 <- c(0.060240964, 0.319230769)
mean(frog11br1)
sd(frog11br1)
frog11br2 <- c(0.939759036, 0.680769231)
mean(frog11br2)
sd(frog11br2)
frog12br <- c(0.657108722,0.517751479)
mean(frog12br)
sd(frog12br)
frog12bd <- c(0.342891278,0.482248521)
mean(frog12bd)
sd(frog12bd)
frog13br <- c(0.700767263)
mean(frog13br)
sd(frog13br)
frog13bd <- c(0.299232737)
mean(frog13bd)
sd(frog13bd)
