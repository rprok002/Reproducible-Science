...
sp <- c(0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0)
par(mar = c(6, 6.5, 2, 0.5), mgp = c(4.5, 1, 0))
barplot(height = volatiles1A$Weight, names.arg = volatiles1A$Frog_Number, space = sp, main = "Dead Bd Chemosensory", ylab = "Proportion of Time", xlab = "Frog Number", col = volatiles1A$Color_Name, ylim = c(0,1.25), las=1, cex.lab = 1.0, cex.axis = 1.5, cex.names = 1.5, font.lab = 2)
legend(4 ,1.25 , legend = c( "Broth", "Neutral","Bd"), col = c("chartreuse4", "grey66", "darkviolet"), pch = 15, cex = 0.75, text.font = 0.75)

volatiles1Aall <- read.csv(file.choose())
sp <- c(0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0, 0.6, 0, 0)
par(mar = c(6, 6.5, 2, 0.5), mgp = c(4.5, 1, 0))
barplot(height = volatiles1Aall$Weight, names.arg = volatiles1Aall$Frog_Number, space = sp, main = "Dead Bd Chemosensory", ylab = "Proportion of Time", xlab = "Frog Number", col = volatiles1Aall$Color_Name, ylim = c(0,1.25), las=1, cex.lab = 1.0, cex.axis = 1.5, cex.names = 1.5, font.lab = 2)
legend(4 ,1.25 , legend = c( "Broth", "Neutral","Bd"), col = c("chartreuse4", "grey66", "darkviolet"), pch = 15, cex = 0.75, text.font = 0.75)
